...
class Verify_the_properties_bean_Test {
  ...
  //   var sut = new AvroBeansConfig().producerProperties(bootstrapUrl, registryUrl, strategy.toString());
  ...
  //   then(sut.getProperty("security.protocol")).isEqualTo(bootstrapUrl.startsWith("https://") ? "SSL" : "PLAINTEXT");

...
public final class UrlUtils {
  ...
  public static final UnaryOperator<String> concatConfluentMap = url ->
    String.format(CONFLUENT_COMPAT_MAP_FMT, url);

  /** Function for removing the final forward slash (/) char if exists from a string url. */
  public static final UnaryOperator<String> cleanUrlEnd = url ->
